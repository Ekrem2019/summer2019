...
public class PrimitiveDataTypes {
	...
	// byte: we can assign whole numbres. -128 <= byte <=127
		...
		long: we  can only assign whole number. must be with in  
	...
	// byte 9num=100; variables name must start with a~z, or A~Z
	...
	// byte byteNumber2= shortNumber2; short is greaterthan byte
	...
	// left side of the= has to be equal or greater than the right side of =
		...
		float eaxmplenum3=20.5f;
		
		double doubleNumber= 10.5;
		double doubleNumber2= 30.5;
		// float floatNumber=doubleNumber2; double datatype is larger than float datatype
		System.out.println("==============================");
		byte bNum=10;
		short sNum=20;
		int iNum=30;
